...
describe PagesController do
  ...
  describe "routing" do
    ...
    it "routes show to pages#shows" do
      expect(:get => '/shows').to route_to(:controller => "pages", :action => "shows")
    end

    it "routes music to pages#music" do
      expect(:get => '/music').to route_to(:controller => "pages", :action => "music")
    end

    it "routes media to pages#photos" do
      expect(:get => '/media').to route_to(:controller => "pages", :action => "photos")
    end

    it "routes band to pages#band" do
      expect(:get => '/band').to route_to(:controller => "pages", :action => "band")
    end
